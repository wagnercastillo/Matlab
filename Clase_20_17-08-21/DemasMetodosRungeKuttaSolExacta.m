...
%Calcular resultados con la solución exacta
for i=1:n+1
    solucionExacta(i) = exp(1/4-(1/2-x(i))^2);
end

T = table(x(:),y1(:),y2(:),y(:), solucionExacta(:));
T.Properties.VariableNames = {'x','Heun','Euler','RungeKutta','Solucion_Exacta'}
